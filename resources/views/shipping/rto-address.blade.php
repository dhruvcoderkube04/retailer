...
@section('content')
                        ...
                        <div class="col-xl-6" data-kt-billing-element="card">
                            ...
                            <div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
                                ...
                                <div class="d-flex flex-column py-2">
                                    <!--begin::Owner-->
                                    <div class="d-flex align-items-center fs-4 fw-bold mb-5">{{ $address->first_name }} {{ $address->last_name }}
    ...
    <!--end::Content-->
      ...
      <div class="modal fade @if ($errors->any()) show d-block @endif" id="addAddressModal" tabindex="-1" aria-labelledby="addAddressModalLabel" aria-hidden="true">
                        ...
                        <form id="editAddressForm" action="{{ url('/rto-address/update') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('state') is-invalid @enderror" name="state" id="edit_state" required>
                                    @error('state') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">City <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('city') is-invalid @enderror" name="city" id="edit_city" required>
                                    @error('city') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>
                            </div>
