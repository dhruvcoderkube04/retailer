            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <!--begin::Title-->
                        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Category List</h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    @foreach ($categories as $categorie)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="text-gray-800 text-hover-primary mb-1">{{strtoupper($categorie->category_name) ?? ''}}</a>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('admin.category.detail',$categorie->id)}}" class="menu-link px-3">View</a>
                                                    </div>
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <form action="{{ route('admin.category.delete', $categorie->id) }}" method="post" style="display: inline;">
                                                            @csrf
                                                            <button type="submit" class="menu-link px-3 text-danger bg-transparent border-0 p-0" style="cursor: pointer;">
                                                                Delete
                                                            </button>
                                                        </form>
                                                    </div>
