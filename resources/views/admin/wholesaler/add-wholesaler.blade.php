            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <!--begin::Title-->
                        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Add Wholesaler</h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">
                                <a href="#" class="text-muted text-hover-primary">Wholesaler</a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">Add Wholesaler</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                            ...
                            <form  class="form" method="post" action="{{route('admin.post.wholesaler')}}">
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <select name="country" aria-label="Select a Country" data-control="select2"  data-placeholder="Select a country..." class="form-select form-select-solid form-select-lg fw-semibold @error('country') is-invalid @enderror">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <select name="state" aria-label="Select a State" data-control="select2" data-placeholder="Select a State..." class="form-select form-select-solid form-select-lg fw-semibold @error('state') is-invalid @enderror">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="city" class="form-control form-control-lg form-control-solid @error('city') is-invalid @enderror" placeholder="City" value="{{old('city')}}"/>
                                            @error('city')
                                                <div class="invalid-feedback">{{ $message }} </div>
                                            @enderror
                                        </div>
                                ...
                                <div class="card-footer d-flex justify-content-end py-6 px-9">
                                    ...
                                    <button type="submit" class="btn btn-primary" >Add Wholesaler</button>
                                </div>
                                <!--end::Actions-->
                            </form>
                            <!--end::Form-->
