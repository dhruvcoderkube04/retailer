                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Search Ticket" />
                                </div>
                                <!--end::Search-->
                            </div>
                            <!--begin::Card title-->
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                                    <!--begin::Add subscription-->
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_ticket">
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    @foreach ($tickets as $ticket)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="text-gray-800 text-hover-primary mb-1">{{$ticket->ticket_id}}</a>
                                            </td>
                                            <td>
                                                <p>{{$ticket->subject}}</p>
                                            </td>
                                            ...
                                            <td>
                                                <div class="symbol symbol-50px me-3">
                                                    <img src="{{asset('uploads/ticket/'.$ticket->ref_image)}}" class="" alt="">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="badge
                                            ...
                                            <td class="text-end">
                                                <button class="btn btn-icon btn-danger btn-light-danger w-30px h-30px me-3 delete-ticket"
                                                ...
                                                <button class="btn btn-icon btn-success btn-light-success w-30px h-30px me-3 edit-ticket"
                                                        data-id="{{$ticket->ticket_id}}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form id="ticketupdateform" class="form" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Ticket Name</label>
                            <input type="text" class="form-control ticket_name" id="edit_ticket_subject" name="subject">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Ticket Description</label>
                            <input type="text" class="form-control ticket_description" id="edit_ticket_description" name="ticket_description">
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.image_ref && response.image_ref.trim() !== "") {
                            let imageUrl = "{{ asset('uploads/ticket') }}/" + response.image_ref;
                            $('#edit_ticket_image_ref').css('background-image', 'url("' + imageUrl + '")');
                        } else {
                            console.log("No image found, setting default.");
                            $('#edit_ticket_image_ref').css('background-image', 'url("assets/media/svg/avatars/blank.svg")');
                        }
