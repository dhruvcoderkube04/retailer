...
<table border="1" cellpadding="8" cellspacing="0" width="100%" style="margin-bottom: 30px; font-family: Arial, sans-serif; border-collapse: collapse; border: 1px solid #e0e0e0;">
...
@if (!empty($cancelled_reason))
    <h3 style="font-family: Arial, sans-serif; background-color: #fff3cd; padding: 10px; border-left: 5px solid #f39c12;">
