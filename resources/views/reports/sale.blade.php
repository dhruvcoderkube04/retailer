                ...
                <div id="kt_app_toolbar_container" class="app-container  d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-6 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">Sales Reports</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body pt-5">
                            <div class="table-responsive">
                                <table class="table align-middle table-striped fs-6 gy-5"
                                    id="kt_datatable_retailer_sales">
                                    <thead>
                                        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0 align-middle border-0">
                                            ...
                                            <th class="text-center min-w-100px">Product Name</th>
                                            <th class="text-center min-w-100px">Weight</th>
                                            <th class="text-center min-w-100px">Order Amount</th>
...
@section('script')
    <script>
        ...
        dataTable = $('#kt_datatable_retailer_sales').DataTable({
            dom: "<'row mb-5'" +
            ...
            //},
            ajax: {
                url: "{{ route('sale.report.fetch-record') }}",
                type: "POST",
                data: function(d) {
                    d._token = '{{ csrf_token() }}';
                    // d.retailer_filter = $('#retailer_filter').val();
                    // d.wholesaler_filter = $('#wholesaler_filter').val();
                    // d.courier_service_filter = $('#courier_service_filter').val();
