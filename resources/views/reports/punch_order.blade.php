...
@section('title')
    Punch Order Report | TechtrendMart
@endsection
                ...
                <div id="kt_app_toolbar_container" class="app-container  d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-6 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">Punch Order Report</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table align-middle table-striped fs-6 gy-5"
                                    ...
                                    <thead>
                                        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0 align-middle border-0">
                                            ...
                                            <th class="text-center min-w-100px">Wallet Debit</th>
...
@section('script')
    <script>
        ...
        dataTable = $('#kt_datatable_punch_order').DataTable({
            dom: "<'row mb-5'" +
            ...
            //},
            ajax: {
                url: "{{ route('punch.order.report.fetch-record') }}",
                type: "POST",
                data: function(d) {
                    d._token = '{{ csrf_token() }}';
