...
<!-- Bootstrap Modal -->
<div class="modal fade @if ($errors->any()) show d-block @endif" id="placeOrderModal" tabindex="-1" aria-labelledby="placeOrderModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
         ...
         <form id="customerForm" method="POST" action="{{ route('retailer.place-order') }}">
            ...
            <div class="modal-footer">
               ...
               <button type="submit" class="btn btn-primary" form="customerForm">Place Order</button>
            </div>
         </form>
      </div>
   </div>
