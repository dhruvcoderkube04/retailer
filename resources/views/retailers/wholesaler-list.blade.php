                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-center flex-column py-9 px-5">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
                                                <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">{{$wholesaler->userDetail->company_name}}</a>
                                                <!--end::Name-->
                                                <!--begin::Position-->
                                                <div class="fw-semibold text-gray-500 mb-6">{{ $wholesaler->firstname }} {{ $wholesaler->lastname}}</div>
                                                <!--end::Position-->
                                                <!--begin::Info-->
                                                ...
                                                <!--end::Info-->
                                                <!--begin::Follow-->
                                                <a href="{{route('retailer.wholesalerwise.productlist', $wholesaler->id)}}" class="btn btn-primary">View Product</a>
                                                <!--end::Follow-->
                                            </div>
                                            <!--begin::Card body-->
                                        </div>
