                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="row gx-5 gx-xl-10 mb-xl-10">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-10">
                            <!--begin::Card widget 4-->
                            <a href="{{route('wholesale.product.list')}}">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--end::Currency-->
                                                <!--begin::Amount-->
                                                <span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2">{{$data['wholesaer_total_product']}}</span>
                                                <!--end::Amount-->
                                                <!--begin::Badge-->
                                            ...
                                            <!--end::Info-->
                                            <!--begin::Subtitle-->
                                            <span class="text-gray-500 pt-1 fw-semibold fs-6">Active Product</span>
                                            <!--end::Subtitle-->
                                        </div>
                                        <!--end::Title-->
                                    </div>
