        ...
        <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('retailer.order.list') }}" class="btn btn-sm fw-bold btn-primary">Check New Orders</a>
                </div>
            </div>
        </div>
                                ...
                                <div class="card h-lg-60 text-center">
                                    ...
                                    ">
                                        ...
                                        <div class="d-flex flex-column my-7">
                                            ...
                                            <div class="mt-4">
                                                <span class="fw-semibold fs-5 text-gray-500">Total Sales <br></span>
                                            </div>
                                        </div>
                                        {{-- <span class="badge badge-light-success fs-base">
                                            <i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
                            ...
                            <div class="col-sm-4 col-xl-3 mb-xl-10">
                                <div class="card h-lg-60 text-center">
                                    ...
                                    ">
                                        ...
                                        <div class="d-flex flex-column my-7">
                                            <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2" id="new_orderss">
                                                {{ $data['new_orders_count'] ?? 0 }}
                                            </span>
                                            <div class="mt-4">
                                                <span class="fw-semibold fs-5 text-gray-500">New Orders</span>
